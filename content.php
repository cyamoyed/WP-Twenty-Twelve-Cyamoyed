	...
	<header class="entry-header">
		<?php if (is_single()): ?>
			...
			<p class="meta"><!--文章页标题下标签-->
				...
				$author_nickname = get_the_author_meta('nickname', $author_id); // 获取作者的昵称
				echo $author_nickname; // 输出作者的昵称
		...
		<div class="single-meta-info gray">
			...
			<span
				class="comment anchor-fix"><?php comments_popup_link('<meta itemprop="interactionCount" content="UserComments:0"/>暂无评论', '<meta itemprop="interactionCount" content="UserComments:1"/>1条评论', '<meta itemprop="interactionCount" content="UserComments:%"/>%条评论', '', '已关闭评论'); ?></span>
		</div>
	...
	<?php if (is_single()): ?>
		...
		<div class="author-info">
			<div class="author-description">
				<p>除非注明，<a href="<?php echo home_url(); ?>"
						target="_blank"><?php echo get_option('blogname'); ?></a>文章均为原创，本文地址 <a
						href="<?php the_permalink() ?>" target="_blank"
						rel="bookmark"><?php the_permalink(); ?></a>，转载请以链接形式注明出处。</p>
