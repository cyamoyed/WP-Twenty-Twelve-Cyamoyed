...
<?php
	...
	if ( is_home() || is_front_page() ) {
		...
		echo "\n";
		echo '<meta property="twitter:image" content="'.get_bloginfo("template_directory").'/images/default_first_img.jpg" />';
		echo "\n";
		...
		echo "\n";
		echo '<meta property="og:image" content="'.get_bloginfo("template_directory").'/images/default_first_img.jpg" />';
	}
?>
